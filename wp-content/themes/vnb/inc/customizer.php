<?php
	function wpb_customize_register($wp_customize){
		...
		$wp_customize->add_setting('showcase_text', array(
			'default' => _x('This is BoxThis is BoxThis is BoxThis is BoxThis is BoxThis is BoxThis is BoxThis is BoxThis is BoxThis is BoxThis is BoxThis is BoxThis is BoxThis is Box', 'wpbootstrap'),
			'type' => 'theme_mod'
		));
